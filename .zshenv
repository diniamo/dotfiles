...
# fzf
export FZF_DEFAULT_OPTS="--color=bg+:#24273A --reverse --border=rounded --no-scrollbar --bind=btab:up,tab:down"
# export FZF_DEFAULT_COMMAND="rg ~ --files --no-ignore"

export _ZO_FZF_OPTS="--exact --no-sort --bind=btab:up,tab:down --cycle --keep-right --border=rounded --height=100% --info=inline --reverse --tabstop=1 --no-scrollbar --color=bg+:#24273A"
